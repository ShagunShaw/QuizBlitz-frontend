...
export const QuizCard = ({ quiz }: QuizCardProps) => {
  return (
    <motion.div
      ...
      className="bg-gray-900 rounded-2xl shadow-sm border border-gray-700 overflow-hidden hover:shadow-xl transition-shadow flex flex-col h-full relative group"
    >
      ...
      <div className="p-5 flex-1 flex flex-col">
        <p className="text-gray-300 text-sm flex-1 mb-4 line-clamp-3">
        ...
        <div className="mt-5 pt-4 border-t border-gray-800 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className={`px-2.5 py-1 rounded-full text-xs font-bold ${quiz.isPermanent ? 'bg-green-100 text-green-300' : 'bg-orange-900/50 text-orange-300'}`}>
